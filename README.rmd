...
Visit the [usecases](https://github.com/goergen95/cesium/tree/main/usecases) directory on 
GitHub to explore applications of the `cesium` package.

### NOAA - Arctic Sea Ice Extent 2000 - 2022

![Animation of arctic sea ice extent](./usecases/assets/arctic-sea-ice.gif)

### Global Forest Watch - Deforestation in Rondonia, Brazil 2000 - 2020

![Animation of forest loss in Rondonia, Brazil](./usecases/assets/rondonia-deforestation.gif)

### NASA FIRMS - Fires in Serengeti National Park, Tanzania 2010 - 2020

![Animation of fire detections in the Serengeti National Park, Tanzania](./usecases/assets/serengeti-fires.gif)

### NOAA - Atlantic hurricanes 2004 - 2021 timelapse

![Animation of atlantic hurricanes from the NOAA database 2004 - 2021](./usecases/assets/hurricanes.gif)
